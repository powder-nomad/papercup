...
// SDK-shaped backends (anthropic-api, openai-compat, gemini-api) are not
// ported in this pass: they don't spawn a CLI, so they'd need a different
// transport entirely. Track as future work.
